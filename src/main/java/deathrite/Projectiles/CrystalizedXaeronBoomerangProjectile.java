...
public class CrystalizedXaeronBoomerangProjectile extends BoomerangProjectile {
    public CrystalizedXaeronBoomerangProjectile() {
    }
    ...
    public Color getParticleColor() {
        return new Color(44, 7, 77);
    }

    public Trail getTrail() {
        return new Trail(this, this.getLevel(), new Color(44, 7, 77), 20.0F, 500, 18.0F);
    }

...
public class AetherArrowVisualProjectile extends Projectile {
    protected long spawnTime;

    public AetherArrowVisualProjectile() {
    }

    public AetherArrowVisualProjectile(Mob owner, float x, float y, float targetX, float targetY, float speed, int distance, GameDamage damage, int knockback) {
        this.setOwner(owner);
        this.x = x;
        this.y = y;

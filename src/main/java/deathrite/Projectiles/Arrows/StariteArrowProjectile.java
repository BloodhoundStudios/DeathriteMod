...
public class StariteArrowProjectile extends Projectile {
    public StariteArrowProjectile() {
    }
    ...
    public Trail getTrail() {
        return new Trail(this, this.getLevel(), new Color(230, 193, 11), 12.0F, 250, this.getHeight());
    }

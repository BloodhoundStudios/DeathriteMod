...
public class AetherArrowProjectile extends Projectile {
    public AetherArrowProjectile() {
    }
    ...
    public Trail getTrail() {
        return new Trail(this, this.getLevel(), new Color(19, 138, 189), 12.0F, 250, this.getHeight());
    }

...
public class ShootingStarGreatswordProjectile extends Projectile {
    protected long spawnTime;

    public ShootingStarGreatswordProjectile() {
    }

    public ShootingStarGreatswordProjectile(Level level, Mob owner, int x, int y, int targetX, int targetY, GameDamage damage, float speed, int range) {
        this.setOwner(owner);
        this.x = (float)x;
        this.y = (float)y;
        this.setLevel(level);
        this.setTarget((float)targetX, (float)targetY);

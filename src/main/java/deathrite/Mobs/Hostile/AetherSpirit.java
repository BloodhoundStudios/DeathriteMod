package deathrite.Mobs.Hostile;
...
public class AetherSpirit extends FlyingHostileMob {

    // Loaded in examplemod.ExampleMod.initResources()
    public static GameTexture texture;

    public static LootTable lootTable = new LootTable(
            ChanceLootItem.between(0.5f, "passedspirits", 1, 3) // 50% chance to drop between 1-3 example items
    );
    ...
    public AetherSpirit() {
        ...
        collision = new Rectangle(-14, -12, 28, 24);

...
public class AethiumHelmetItem extends SetHelmetArmorItem {
    public AethiumHelmetItem() {
        super(20, (DamageType)null, 1300, HeadArmorLootTable.headArmor, ArmorSetsLootTable.armorSets, Rarity.EPIC, "aethiumhelmet", "aethiumchestplate", "aethiumboots", "ancientfossilhelmetsetbonus");

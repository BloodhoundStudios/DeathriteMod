...
public class AethiumWorkstationObject extends CraftingStationObject {
    public ObjectDamagedTextureArray texture;
    protected int counterID;

    public AethiumWorkstationObject() {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = ObjectDamagedTextureArray.loadAndApplyOverlay(this, "objects/aethiumworkstation");
    }
    ...
    public Tech[] getCraftingTechs() {
        return new Tech[]{RecipeTechRegistry.getTech("aethiumworkstation"), RecipeTechRegistry.FALLEN_WORKSTATION, RecipeTechRegistry.DEMONIC_WORKSTATION, RecipeTechRegistry.WORKSTATION, RecipeTechRegistry.ADVANCED_WORKSTATION};
    }

    public ListGameTooltips getItemTooltips(InventoryItem item, PlayerMob perspective) {
        ListGameTooltips tooltips = super.getItemTooltips(item, perspective);
        tooltips.add(Localization.translate("itemtooltip", "aethiumworkstationtip"));
        return tooltips;
    }

    public static int[] registerWorkstation() {
        AethiumWorkstationObject o1 = new AethiumWorkstationObject();
        AethiumWorkstation2Object o2 = new AethiumWorkstation2Object();
        int i1 = ObjectRegistry.registerObject("aethiumworkstation", o1, 180, true);
        int i2 = ObjectRegistry.registerObject("aethiumworkstation2", o2, 0.0F, false);
        o1.counterID = i2;
        o2.counterID = i1;

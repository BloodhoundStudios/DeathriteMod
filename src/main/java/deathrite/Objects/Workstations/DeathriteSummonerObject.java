...
public class DeathriteSummonerObject extends CraftingStationObject {
    public ObjectDamagedTextureArray texture;
    protected int counterID;

    public DeathriteSummonerObject() {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = ObjectDamagedTextureArray.loadAndApplyOverlay(this, "objects/deathritesummoner");
    }
    ...
    public Tech[] getCraftingTechs() {
        return new Tech[]{RecipeTechRegistry.getTech("deathritesummoner")};
    }

    public ListGameTooltips getItemTooltips(InventoryItem item, PlayerMob perspective) {
        ListGameTooltips tooltips = super.getItemTooltips(item, perspective);
        tooltips.add(Localization.translate("itemtooltip", "deathritesummonertip"));
        return tooltips;
    }

    public static int[] registerWorkstation() {
        DeathriteSummonerObject o1 = new DeathriteSummonerObject();
        DeathriteSummoner2Object o2 = new DeathriteSummoner2Object();
        int i1 = ObjectRegistry.registerObject("deathritesummoner", o1, 290, true);
        int i2 = ObjectRegistry.registerObject("deathritesummoner2", o2, 0.0F, false);
        o1.counterID = i2;
        o2.counterID = i1;
